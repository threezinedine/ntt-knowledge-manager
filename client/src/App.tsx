    ...
    <main className="workspace">
      ...
      <article className="editor">
        ...
        <div className="document">
          ...
          <h2>{activeNote}</h2>
          <p className="lead">
            A place to turn scattered observations into decisions that stay
            useful.
          </p>
          <hr />
          <h3>Focus</h3>
          <p>
            Build a quiet, dependable system for collecting ideas, connecting
            context, and returning to the important pieces when work gets
            complicated.
          </p>
          <h3>Next steps</h3>
          <ul>
            ...
            <li>Review the open questions at the end of the week.</li>
          </ul>
        </div>
      </article>
    </main>
